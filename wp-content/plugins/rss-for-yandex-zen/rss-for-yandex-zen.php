...
function yzen_files_admin($hook_suffix) {
    ...
    wp_register_script('yzen-script', $purl . '/inc/yzen-script.js', array(), '1.25');  
...
<div class="postbox">
    <h3 style="border-bottom: 1px solid #EEE;background: #f7f7f7;"><span class="tcode"><?php _e('Яндекс.Турбо', 'rss-for-yandex-zen'); ?></span></h3>
	  <div class="inside" style="padding-bottom:15px;display: block;">
     
        <table class="form-table">
        
        <p><?php _e("Все функции сервиса Яндекс.Турбо были удалены из этого плагина (сервис активно развивается и добавляет новые опции - внедрять их поддержку сразу в оба плагина слишком накладно). <br /> Используйте отдельный специализированный плагин <a target='new' href='https://ru.wordpress.org/plugins/rss-for-yandex-turbo/'>RSS for Yandex Turbo</a>. ", "rss-for-yandex-zen"); ?> </p>
...
<channel>
    ...
    <generator>RSS for Yandex Zen v1.25 (https://wordpress.org/plugins/rss-for-yandex-zen/)</generator>
