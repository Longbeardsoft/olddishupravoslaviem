...
$(".cp-controls .cp-pause").css("margin-left","100px");
$(".cp-controls .cp-play").css("margin-left","100px");
$(".cp-controls .cp-play:hover").css("margin-left","100px");
$(".cp-controls .cp-pause:hover").css("margin-left","100px");
}
