...
?>
    <div class="inputcomments">
        <h2 class="inputpostheader nocomments"><?php _e('This post is password protected. Enter the password to view any comments.', THEME_NS) ?></h2>
    </div>
<?php
	return;
}
...
?>
    <div class="inputcomments">
        <h2 class="inputpostheader comments"><?php printf(
...
echo str_replace(
    ...
    array('id="respond" class="inputcommentsform"', '<h2', 'id="reply-title" class="inputpostheader"', '</h2>', 'inputpostcontent logged-in-as', 'class="inputbutton" type="submit"'), 
    theme_ob_get_clean());