 ...
 *
 * The showcase template in Deep Breath consists of a featured posts section using sticky posts,
...
wp_enqueue_script( 'deepbreath-showcase', get_template_directory_uri() . '/js/showcase.js', array( 'jquery' ), '2011-04-28' );
		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
				...
				if ( ! empty( $sticky ) ) :
					...
					<h1 class="showcase-heading"><?php _e( 'Featured Post', 'deepbreath' ); ?></h1>
					...
					<section class="featured-post <?php echo esc_attr( $feature_class ); ?>" id="featured-post-<?php echo esc_attr( $counter_slider ); ?>">
							...
							if ( has_post_thumbnail() ) {
								...
								?>
						<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'deepbreath' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_post_thumbnail( $thumbnail_size ); ?></a>
								<?php
							}
							?>
					...
					<ul>
							...
							while ( $featured->have_posts() ) :
								...
								?>
					<li><a href="#featured-post-<?php echo esc_attr( $counter_slider ); ?>" title="<?php echo esc_attr( sprintf( __( 'Featuring: %s', 'deepbreath' ), the_title_attribute( 'echo=0' ) ) ); ?>"<?php echo $class; ?>></a></li>
						<?php endwhile; ?>
					</ul>
					</nav>
				...
				<section class="recent-posts">
					<h1 class="showcase-heading"><?php _e( 'Recent Posts', 'deepbreath' ); ?></h1>
					...
					while ( $recent->have_posts() ) :
						...
						<li class="entry-title">
							...
							<span class="comments-link">
								<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a reply', 'deepbreath' ) . '</span>', __( '<b>1</b> Reply', 'deepbreath' ), __( '<b>%</b> Replies', 'deepbreath' ) ); ?>
							</span>
						</li>
